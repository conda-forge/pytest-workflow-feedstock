...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytest-workflow-feedstock/blob/master/LICENSE.txt)
...
Once the `conda-forge` channel has been enabled, `pytest-workflow` can be installed with:

```
conda install pytest-workflow
```

It is possible to list all of the versions of `pytest-workflow` available on your platform with:
